...
const DiceGame = () => {
  ...
  useEffect(() => {
    ...
    const bluePositions = document.querySelectorAll(".blue-side .position");
    const yellowPositions = document.querySelectorAll(".yellow-side .position");
    ...
    function moveToken(token, newIndex, positions) {
      if (newIndex >= 0 && newIndex < positions.length) {
        ...
        const parentRect = newPosition.parentElement.getBoundingClientRect();
    ...
    <div className="container">
      ...
      <div className="board">
        <div className="side blue-side">
          ...
          <div ref={blueTokenRef} className="token blue-token"></div>
        </div>
        <div className="side yellow-side">
          ...
          <div ref={yellowTokenRef} className="token yellow-token"></div>
        </div>
      </div>
      ...
      <p ref={resultTextRef} id="result"></p>
      <button ref={rollDiceButtonRef} id="roll-dice">
        Roll Dice
      </button>
    </div>
  );
