...
const FootballTeamFormation = () => {
  ...
  const formations = {
    "4-4-2": [
      { name: "Goalkeeper", player: "Ali Rezaei", top: "90%", left: "50%" },
      {
        name: "Center Back 1",
        player: "Mehdi Karimi",
        top: "70%",
      ...
      { name: "Right Back", player: "Sina Fathi", top: "60%", left: "80%" },
      {
      ...
      { name: "Striker 2", player: "Reza Jahani", top: "20%", left: "60%" },
    ],
    "4-1-4-1": [
      { name: "Goalkeeper", player: "Ali Rezaei", top: "90%", left: "50%" },
      {
      ...
      { name: "Striker", player: "Reza Jahani", top: "20%", left: "50%" },
    ],
    "4-3-3": [
      { name: "Goalkeeper", player: "Ali Rezaei", top: "90%", left: "50%" },
      {
    ...
    "3-5-2": [
      ...
      { name: "Left Wing Back", player: "Sina Fathi", top: "60%", left: "10%" },
      {
  ...
  const share = () => {
    ...
    if (field) {
      html2canvas(field).then((canvas) => {
        ...
        const shareUrl = `${referralLink}&image=${encodeURIComponent(image)}`;
    ...
    <div className="panle">
      ...
      <div className="share-rating-panel">
        ...
        <div className="rating">
          <span className="star" onClick={() => rate(1)}>
            &#9733;
          </span>
          <span className="star" onClick={() => rate(2)}>
            &#9733;
          </span>
          <span className="star" onClick={() => rate(3)}>
            &#9733;
          </span>
          <span className="star" onClick={() => rate(4)}>
            &#9733;
          </span>
          <span className="star" onClick={() => rate(5)}>
            &#9733;
          </span>
        </div>
      </div>
